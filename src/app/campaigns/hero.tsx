...
function Hero() {
  return (
    <section className="bg-alabaster px-6 py-4">
      <div className="max-w-[1200px] mx-auto flex flex-col-reverse md:flex-row md:flex-nowrap md:items-center md:min-h-[540px]">
